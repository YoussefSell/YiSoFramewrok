namespace YiSoFramework.Animation.Easing
{
    using System;
    ...
    {
        public static EasingDelegate Get(_Easing easing)
        {
            switch (easing)
            {
                case _Easing.Linear: return Linear;
                case _Easing.ExpoEaseOut: return ExpoEaseOut;
                case _Easing.ExpoEaseIn: return ExpoEaseIn;
                case _Easing.ExpoEaseInOut: return ExpoEaseInOut;
                case _Easing.ExpoEaseOutIn: return ExpoEaseOutIn;
                case _Easing.CircEaseOut: return CircEaseOut;
                case _Easing.CircEaseIn: return CircEaseIn;
                case _Easing.CircEaseInOut: return CircEaseInOut;
                case _Easing.CircEaseOutIn: return CircEaseOutIn;
                case _Easing.QuadEaseOut: return QuadEaseOut;
                case _Easing.QuadEaseIn: return QuadEaseIn;
                case _Easing.QuadEaseInOut: return QuadEaseInOut;
                case _Easing.QuadEaseOutIn: return QuadEaseOutIn;
                case _Easing.SineEaseOut: return SineEaseOut;
                case _Easing.SineEaseIn: return SineEaseIn;
                case _Easing.SineEaseInOut: return SineEaseInOut;
                case _Easing.SineEaseOutIn: return SineEaseOutIn;
                case _Easing.CubicEaseOut: return CubicEaseOut;
                case _Easing.CubicEaseIn: return CubicEaseIn;
                case _Easing.CubicEaseInOut: return CubicEaseInOut;
                case _Easing.CubicEaseOutIn: return CubicEaseOutIn;
                case _Easing.QuartEaseOut: return QuartEaseOut;
                case _Easing.QuartEaseIn: return QuartEaseIn;
                case _Easing.QuartEaseInOut: return QuartEaseInOut;
                case _Easing.QuartEaseOutIn: return QuartEaseOutIn;
                case _Easing.QuintEaseOut: return QuintEaseOut;
                case _Easing.QuintEaseIn: return QuintEaseIn;
                case _Easing.QuintEaseInOut: return QuintEaseInOut;
                case _Easing.QuintEaseOutIn: return QuintEaseOutIn;
                case _Easing.ElasticEaseOut: return ElasticEaseOut;
                case _Easing.ElasticEaseIn: return ElasticEaseIn;
                case _Easing.ElasticEaseInOut: return ElasticEaseInOut;
                case _Easing.ElasticEaseOutIn: return ElasticEaseOutIn;
                case _Easing.BounceEaseOut: return BounceEaseOut;
                case _Easing.BounceEaseIn: return BounceEaseIn;
                case _Easing.BounceEaseInOut: return BounceEaseInOut;
                case _Easing.BounceEaseOutIn: return BounceEaseOutIn;
                case _Easing.BackEaseOut: return BackEaseOut;
                case _Easing.BackEaseIn: return BackEaseIn;
                case _Easing.BackEaseInOut: return BackEaseInOut;
                case _Easing.BackEaseOutIn: return BackEaseOutIn;
